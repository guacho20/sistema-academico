...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Panel de administración | Sistema de matricula e inscripciones</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="description" content="Registro Ficha de Datos">
    <meta name="author" content="Registro Ficha de Datos - Jhon Guacho" />
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=start" class="logo">
          ...
          <span style="font-size:20px">SISINSPIRA</span>
        </a>
          ...
          <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="fa fa-sign-out"> Cerrar Sesion</i></h4>
                </div>
                <div class="modal-body">
                    <p>¿Seguro que quieres salir? </p>
                </div>
                <div class="modal-footer">
                    <a type="button" class="btn btn-success" href="logout.php" ><i class="glyphicon glyphicon-ok"></i> Si, Salir</a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; <?php echo date('Y');?> - <a href="https://www.facebook.com/JhonGuachoGuashpa" target="_blank">Jhon Guacho</a>.</strong>
      </footer>
    </div><!-- ./wrapper -->
