<?php
	...
	//Consulta
	$sql = "SELECT codigo, descripcion, fecha_creacion FROM nivel";
	...
	$objPHPExcel->getActiveSheet()->setCellValue('B6', 'DESCRIPCIÓN');
	$objPHPExcel->getActiveSheet()->getColumnDimension('C')->setWidth(10);
	$objPHPExcel->getActiveSheet()->setCellValue('C6', 'FECHA CREACIÓN');
	
	//Recorremos los resultados de la consulta y los imprimimos
	while($rows = $resultado->fetch_assoc()){
		
		$objPHPExcel->getActiveSheet()->setCellValue('A'.$fila, $rows['codigo']);
		$objPHPExcel->getActiveSheet()->setCellValue('B'.$fila, $rows['descripcion']);
		$objPHPExcel->getActiveSheet()->setCellValue('C'.$fila, $rows['fecha_creacion']);
