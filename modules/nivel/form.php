...
if ($_GET['form']=='edit') { 
  if (isset($_GET['id'])) {
      ...
      $query = mysqli_query($mysqli, "SELECT codigo,descripcion FROM nivel WHERE codigo='$_GET[id]'") 
...
?>
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-line-chart"></i> Modificar Nivel
    </h1>
    <ol class="breadcrumb">
      <li><a href="?module=start"><i class="fa fa-home"></i> Inicio </a></li>
      <li><a href="?module=nivel"> Nivel </a></li>
        ...
        <div class="col-md-5">
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <form action="modules/nivel/proses.php?act=update" method="POST" >
