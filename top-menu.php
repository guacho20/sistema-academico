...
<li class="dropdown user user-menu">
  ...
  <ul class="dropdown-menu">
    ...
    <li class="user-footer">
      <div class="pull-left">
        <a style="width:100px" href="?module=profile" class="btn btn-info btn-flat"><i style="color:#fff" class="glyphicon glyphicon-user"></i>  Perfil</a>
      </div>

      <div class="pull-right">
        <a style="width:120px" data-toggle="modal" href="#logout" class="btn btn-danger btn-flat"><i style="color:#fff" class="glyphicon glyphicon-off"></i>  Cerrar Sesión</a>
      </div>
    </li>
  </ul>
</li>